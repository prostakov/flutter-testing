...
class _ProductInfoState extends State<ProductInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Product> sellerProducts = [
      Product("assets/ProductImages/onion.png", locale.freshRedOnios, "Pajeroma", "\$30.0"),
      Product("assets/ProductImages/tomato.png", locale.freshRedTomatoes, "Lecoil Eeva", "\$44.0"),
      Product("assets/ProductImages/Potatoes.png", locale.mediumPotatoes, "Pajeroma", "\$29.0"),
      Product("assets/ProductImages/lady finger.png", locale.freshLadiesFinger, "Operum England", "\$32.0"),
      Product("assets/ProductImages/Garlic.png", locale.freshGarlic, "Pajeroma", "\$30.0"),
      Product("assets/ProductImages/Cauliflower.png", locale.cauliFlower, "Calvis Dino", "\$35.0"),
      Product("assets/ProductImages/lady finger.png", locale.freshLadiesFinger, "Operum England", "\$32.0"),
      Product("assets/ProductImages/Garlic.png", locale.freshGarlic, "Pajeroma", "\$30.0"),
      Product("assets/ProductImages/Cauliflower.png", locale.cauliFlower, "Calvis Dino", "\$35.0"),
    ];
        ...
        child: Column(
          children: [
            Stack(
              children: [
                //Container(),
                Image.asset("assets/ProductImages/lady finger.png", fit: BoxFit.fill),
                ...
                Positioned.directional(
                    ...
                    child: IconButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => CheckOutNavigator()));
                        },
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: Theme.of(context).textTheme.headline3.copyWith(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20),
                  ),
                  SizedBox(
                    height: 5,
                  ),
                  ...
                  Row(
                    children: [
                      Text("\$32.0", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 20)),
                      Spacer(),
                      TextButton(
                          onPressed: () {
            ...
            CustomButton(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => CheckOutNavigator())),
              height: 60,
              iconGap: 12,
            ...
            ListTile(
              title: GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => SellerInfo()));
                },
                child: RichText(
                  text: TextSpan(
                      text: locale.moreBy + ' ',
                      ...
                      children: <TextSpan>[
                        TextSpan(text: locale.seller, style: TextStyle(fontWeight: FontWeight.w500)),
                      ]),
                ),
              ),
              trailing: TextButton(
